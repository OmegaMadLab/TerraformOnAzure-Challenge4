...
![Azure Eats Website](Documents/Images/Website.png)
...
- [Azure Eats](https://github.com/Microsoft/TailwindTraders)
...
1. **You must have an AKS with all the Azure Eats Backend Up & Running**. Please follow the instructions on [Azure Eats Backend repo](https://github.com/Microsoft/TailwindTraders-Backend/) to deploy the backend on AKS.
