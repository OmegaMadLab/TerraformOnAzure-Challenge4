...
namespace Tailwind.Traders.Web.Controllers
{
    ...
    {
        private const string powerTools = "Mars Bars";
        private const string gardenCenter = "Betelgeuse Gazeuze";
        private const string electrical = "Moon Cheese";
        private const string plumbing = "Canned Neptuna";
