        ...
        public async Task Seed()
        {
            ...
            using (var conn = new SqlConnection(connectionString))
            {
                ...
                if (await IsDatabaseEmpty(conn))
                {
                    ...
                    await SeedTable(conn, "Brands", "https://raw.githubusercontent.com/suuus/TailwindTraders-Backend/master/Source/Services/Tailwind.Traders.Product.Api/Setup/ProductBrands.csv");
                    await CreateTypesTable(conn);
                    await SeedTable(conn, "Types", "https://raw.githubusercontent.com/suuus/TailwindTraders-Backend/master/Source/Services/Tailwind.Traders.Product.Api/Setup/ProductTypes.csv");
                    await CreateTagsTable(conn);
                    await SeedTable(conn, "Tags", "https://raw.githubusercontent.com/suuus/TailwindTraders-Backend/master/Source/Services/Tailwind.Traders.Product.Api/Setup/ProductTags.csv");
                    await CreateFeaturesTable(conn);
                    await SeedTable(conn, "Features", "https://raw.githubusercontent.com/suuus/TailwindTraders-Backend/master/Source/Services/Tailwind.Traders.Product.Api/Setup/ProductFeatures.csv");
                    await CreateProductsTable(conn);
                    await SeedTable(conn, "Products", "https://raw.githubusercontent.com/suuus/TailwindTraders-Backend/master/Source/Services/Tailwind.Traders.Product.Api/Setup/ProductItems.csv");
